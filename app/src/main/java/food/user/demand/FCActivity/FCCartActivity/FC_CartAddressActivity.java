...
public class FC_CartAddressActivity extends AppCompatActivity implements View.OnClickListener , OnMapReadyCallback {
...
View parentLayout;
   ...
   //GoogleApi googleApiClient;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.adjustFontScale(FC_CartAddressActivity.this,getResources().getConfiguration());
    ...
    private void CheckPermission() {
        ...
        final LocationManager manager = (LocationManager) FC_CartAddressActivity.this.getSystemService(Context.LOCATION_SERVICE);
        if (Objects.requireNonNull(manager).isProviderEnabled(LocationManager.GPS_PROVIDER) && hasGPSDevice(FC_CartAddressActivity.this)) {

        }
        // Todo Location Already on  ... end

        if (!hasGPSDevice(FC_CartAddressActivity.this)) {
            Toast.makeText(FC_CartAddressActivity.this, "Gps not Supported", Toast.LENGTH_SHORT).show();
        }

        if (!manager.isProviderEnabled(LocationManager.GPS_PROVIDER) && hasGPSDevice(FC_CartAddressActivity.this)) {
    ...
    private void enableLoc() {
      ...
      /*  if (googleApiClient == null) {
            googleApiClient = new GoogleApiClient.Builder(FC_CartAddressActivity.this)
            ...
            public void onFailure(@NonNull Exception e) {
                if (e instanceof ResolvableApiException) {
                    try {
                        ...
                        resolvable.startResolutionForResult(FC_CartAddressActivity.this,
                                REQUEST_LOCATION);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.txt_changeBtn:
                ...
                Intent intent = new Intent(FC_CartAddressActivity.this, FC_CartlocationPickerActivty.class);
...
//                longitude = location.getLongitude();
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(FC_CartAddressActivity.this,
    ...
    private void Register() {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(FC_CartAddressActivity.this);
                ...
                ServerResponse -> {
                    ...
                    try {
                        ...
                        if (FC_Common.status.equalsIgnoreCase("1"))
                        {
                            ...
                            FC_SharedPrefManager.getInstance(FC_CartAddressActivity.this).userLogin(user);
                            SharedPreferences sharedPreferences = FC_CartAddressActivity.this.getSharedPreferences("MyLogin.txt", Context.MODE_PRIVATE);
                            SharedPreferences.Editor editor = sharedPreferences.edit();
                            //editor.putBoolean("FirstLogin", true);
                            editor.commit();
                            SharedPreferences sharedPreferences1 = PreferenceManager.getDefaultSharedPreferences(FC_CartAddressActivity.this);
                            ...
                            editor1.apply();
                            //onBackPressed();
                            Intent intent = new Intent(FC_CartAddressActivity.this,FC_CartActivity.class);
                            startActivity(intent);
                            finish();
                        }
