...
public class FC_locationPickerActivty extends AppCompatActivity implements View.OnClickListener {

    private static String TAG = FC_locationPickerActivty.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = FC_locationPickerActivty.this;
        ...
        if (bundle != null) {
            ...
            Log.d("dfgfdgdfg", "chdfghdf" + FC_Common.latitude);
            Log.d("dfgfdgdfg", "chdfghdf" + FC_Common.longitude);
        }
        ...
        autocompleteFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(@NotNull Place place) {
                ...
                Intent intent = new Intent(FC_locationPickerActivty.this, FC_IntroAddressActivity.class);
    ...
    private void locationlist() {
        ...
        // request queue
        RequestQueue requestQueue = Volley.newRequestQueue(Objects.requireNonNull(FC_locationPickerActivty.this));
    ...
    private void LocationRecycler() {
        ...
        rv_savedaddress.setLayoutManager(new LinearLayoutManager(FC_locationPickerActivty.this, LinearLayoutManager.VERTICAL, false));
    ...
    private void UpdateDefaultAddress(String default_address) {
        ...
        // request queue
        RequestQueue requestQueue = Volley.newRequestQueue(Objects.requireNonNull(FC_locationPickerActivty.this).getApplicationContext());
        requestQueue.add(stringRequest);
        requestQueue.getCache().clear();
    ...
    private void GetUserDetails() {
                    ...
                    try {
                        ...
                        if (FC_Common.status.equalsIgnoreCase("1")) {
                           /* String value="dgsdgsdgsd";
                            ...
                            FC_SharedPrefManager.getInstance(FC_locationPickerActivty.this).userLogin(user);
                            SharedPreferences sharedPreferences = FC_locationPickerActivty.this.getSharedPreferences("MyLogin.txt", Context.MODE_PRIVATE);
                            SharedPreferences.Editor editor = sharedPreferences.edit();
                            //editor.putBoolean("FirstLogin", true);
                            editor.apply();
                            SharedPreferences sharedPreferences1 = PreferenceManager.getDefaultSharedPreferences(FC_locationPickerActivty.this);
                            ...
                            Intent intent = new Intent(FC_locationPickerActivty.this, FC_DashboardActivity.class);
                           /* intent.putExtra("username", FC_Common.username);
                            intent.putExtra("usermobile", FC_Common.usermobile);
                            intent.putExtra("useremail", FC_Common.useremail);
                            intent.putExtra("usergender", FC_Common.usergender);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(FC_locationPickerActivty.this);
        requestQueue.add(stringRequest);
        requestQueue.getCache().clear();
    }
