...
public class FC_IntroAddressActivity extends AppCompatActivity implements View.OnClickListener , OnMapReadyCallback {
...
View parentLayout;
   ...
   //GoogleApi googleApiClient;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.adjustFontScale(FC_IntroAddressActivity.this,getResources().getConfiguration());
    ...
    private void CheckPermission() {
        ...
        final LocationManager manager = (LocationManager) FC_IntroAddressActivity.this.getSystemService(Context.LOCATION_SERVICE);
        if (Objects.requireNonNull(manager).isProviderEnabled(LocationManager.GPS_PROVIDER) && hasGPSDevice(FC_IntroAddressActivity.this)) {
           // Toast.makeText(FC_IntroAddressActivity.this, "Gps already enabled", Toast.LENGTH_SHORT).show();
        }
        // Todo Location Already on  ... end

        if (!hasGPSDevice(FC_IntroAddressActivity.this)) {
            Toast.makeText(FC_IntroAddressActivity.this, "Gps not Supported", Toast.LENGTH_SHORT).show();
        }

        if (!manager.isProviderEnabled(LocationManager.GPS_PROVIDER) && hasGPSDevice(FC_IntroAddressActivity.this)) {
            Log.e("TAG", "Gps already enabled");
            Toast.makeText(FC_IntroAddressActivity.this, "Gps not enabled", Toast.LENGTH_SHORT).show();
            enableLoc();
        } else {
            Log.e("TAG", "Gps already enabled");
            Toast.makeText(FC_IntroAddressActivity.this, "Gps already enabled", Toast.LENGTH_SHORT).show();
    ...
    /*    if (googleApiClient == null) {
            googleApiClient = new GoogleApiClient.Builder(FC_IntroAddressActivity.this)
            ...
            public void onFailure(@NonNull Exception e) {
                if (e instanceof ResolvableApiException) {
                    try {
                        ...
                        resolvable.startResolutionForResult(FC_IntroAddressActivity.this,
                                REQUEST_LOCATION);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.txt_changeBtn:
                ...
                Intent intent = new Intent(FC_IntroAddressActivity.this, FC_locationPickerActivty.class);
            ...
            case R.id.txt_usecurrentlocation:
                inputMgr.hideSoftInputFromWindow(ll_mainLayout.getWindowToken(), 0);
                FC_Common.change_address="intro";
                onMapReady(mGoogleMap);
                break;
    ...
    LocationCallback mLocationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            if (FC_Common.change_address.equalsIgnoreCase("intro")||
                    FC_Common.change_address.equalsIgnoreCase("splash")||
            FC_Common.change_address.equalsIgnoreCase("dash")) {
...
//                longitude = location.getLongitude();
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(FC_IntroAddressActivity.this,
    ...
    private void Register() {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(FC_IntroAddressActivity.this);
                    ...
                    public void onResponse(String ServerResponse) {
                        ...
                        try {
                            ...
                            if (FC_Common.status.equalsIgnoreCase("1"))
                            {
                                ...
                                FC_SharedPrefManager.getInstance(FC_IntroAddressActivity.this).userLogin(user);
                                SharedPreferences sharedPreferences = FC_IntroAddressActivity.this.getSharedPreferences("MyLogin.txt", Context.MODE_PRIVATE);
                                SharedPreferences.Editor editor = sharedPreferences.edit();
                                //editor.putBoolean("FirstLogin", true);
                                editor.commit();
                                SharedPreferences sharedPreferences1 = PreferenceManager.getDefaultSharedPreferences(FC_IntroAddressActivity.this);
                                ...
                                Intent intent = new Intent(FC_IntroAddressActivity.this, FC_DashboardActivity.class);
    ...
    public void onBackPressed() {
           Log.d("dgdsgsdg","change_address"+FC_Common.change_address);
        if (FC_Common.change_address.equalsIgnoreCase("intro")) {
        ...
        else if (FC_Common.change_address.equalsIgnoreCase("dash")){
            Intent intent = new Intent(FC_IntroAddressActivity.this, FC_DashboardActivity.class);
            intent.putExtra("location_name", FC_Common.location_name);
            intent.putExtra("location_type", FC_Common.location_type);
            intent.putExtra("latitude", FC_Common.latitude);
