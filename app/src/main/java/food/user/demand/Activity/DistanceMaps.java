...
public class DistanceMaps extends FragmentActivity implements
    ...
    public void drawPath(String  result) {
        ...
        mMap.addMarker(new MarkerOptions().position(to).icon(
                BitmapDescriptorFactory.fromResource(R.drawable.common_google_signin_btn_icon_dark)));
        mMap.addMarker(new MarkerOptions().position(from).icon(
