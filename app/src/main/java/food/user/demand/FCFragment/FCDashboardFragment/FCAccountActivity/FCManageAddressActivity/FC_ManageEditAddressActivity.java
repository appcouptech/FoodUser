...
public class FC_ManageEditAddressActivity extends AppCompatActivity implements View.OnClickListener , OnMapReadyCallback {
   ...
   //GoogleApi googleApiClient;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null)
        {
            ...
            Log.d("fgjhfghjfg","fdhfdhfd"+FC_Common.access_token);

        }

        if (FC_Common.change_address.equalsIgnoreCase("Addnew"))
        {
        ...
        {
            edt_landmark.setText(FC_Common.addresslandmark);
            edt_home.setText(FC_Common.addressbuilding);
            if (FC_Common.addresstype.equalsIgnoreCase("HOME"))
            {
            ...
            else if (FC_Common.addresstype.equalsIgnoreCase("WORK")){
    ...
    private void CheckPermission() {
        ...
        final LocationManager manager = (LocationManager) FC_ManageEditAddressActivity.this.getSystemService(Context.LOCATION_SERVICE);
        if (Objects.requireNonNull(manager).isProviderEnabled(LocationManager.GPS_PROVIDER) && hasGPSDevice(FC_ManageEditAddressActivity.this)) {
           // Toast.makeText(FC_ManageEditAddressActivity.this, "Gps already enabled", Toast.LENGTH_SHORT).show();
        }
        // Todo Location Already on  ... end

        if (!hasGPSDevice(FC_ManageEditAddressActivity.this)) {
            Toast.makeText(FC_ManageEditAddressActivity.this, "Gps not Supported", Toast.LENGTH_SHORT).show();
        }

        if (!manager.isProviderEnabled(LocationManager.GPS_PROVIDER) && hasGPSDevice(FC_ManageEditAddressActivity.this)) {
            Log.e("TAG", "Gps already enabled");
            //Toast.makeText(FC_ManageEditAddressActivity.this, "Gps not enabled", Toast.LENGTH_SHORT).show();
            enableLoc();
        } else {
            Log.e("TAG", "Gps already enabled");
           // Toast.makeText(FC_ManageEditAddressActivity.this, "Gps already enabled", Toast.LENGTH_SHORT).show();
    ...
    private void enableLoc() {
      ...
      /*  if (googleApiClient == null) {
            googleApiClient = new GoogleApiClient.Builder(FC_ManageEditAddressActivity.this)
...
*/
            ...
            public void onFailure(@NonNull Exception e) {
                if (e instanceof ResolvableApiException) {
                    try {
                        ...
                        resolvable.startResolutionForResult(FC_ManageEditAddressActivity.this,
                                REQUEST_LOCATION);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.txt_changeBtn:
                ...
                Intent intent = new Intent(FC_ManageEditAddressActivity.this, FC_ManagelocationPickerActivty.class);
            ...
            case R.id.txt_saveAddress:
               ...
               // Register();
                ...
                {
                    FC_Common.addressbuilding=edt_home.getText().toString().trim();
    ...
    LocationCallback mLocationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            Log.d("cghfghfgh","fghfg"+FC_Common.addresslatitude);
            Log.d("cghfghfgh","fghfg"+FC_Common.addresslongitude);
            Log.d("cghfghfgh","232dffghfg"+locationList);
            if (FC_Common.change_address.equalsIgnoreCase("current")) {
                if (locationList.size() > 0) {
                  ...
                  //  markerOptions.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_MAGENTA));
                    ...
                    FC_Common.addresslatitude = String.valueOf(latitude);
                    FC_Common.addresslongitude = String.valueOf(longitude);
                    Log.d("dgsdgsdfg", "latitude : " + latitude);
                    Log.d("dgsdgsdfg", "latitude : " + FC_Common.addresslatitude);
                    Log.d("dgsdgsdfg", "longitude : " + longitude);
                    Log.d("dgsdgsdfg", "longitude : " + FC_Common.addresslongitude);
                    //move map camera
            ...
            else
            {
               // Location location = locationList.get(locationList.size() - 1);
                ...
                if (mCurrLocationMarker != null) {
                    mCurrLocationMarker.remove();
                    Log.d("dfgdfgfd53g","43534dfgfdgdf");
                }
                double latitude = Double.parseDouble(FC_Common.addresslatitude);
                double longitude = Double.parseDouble(FC_Common.addresslongitude);
...
//                longitude = location.getLongitude();
               ...
               // markerOptions.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_MAGENTA));
                ...
                FC_Common.addresslatitude = String.valueOf(latitude);
                FC_Common.addresslongitude = String.valueOf(longitude);
                Log.d("dgsdgsdfg", "dfgdfglatitude : " + latitude);
                Log.d("dgsdgsdfg", "dfgdfglatitude : " + FC_Common.addresslatitude);
                Log.d("dgsdgsdfg", "dfgdflongitude : " + longitude);
                Log.d("dgsdgsdfg", "fdghdlongitude : " + FC_Common.addresslongitude);
                //move map camera
                mGoogleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(latLng, 17));
                mGoogleMap.animateCamera(CameraUpdateFactory.zoomTo(17), 2000, null);
                ...
                try {
                   ...
                   if (subLocality  == null)
                    {
                        Log.d(" gmap", " subAdminArea : " +"fdhfdghfd");
                        txt_locationMainField.setText("" + subAdminArea);
                    }
                     else
                    {
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(FC_ManageEditAddressActivity.this,
        ...
        if (requestCode == MY_PERMISSIONS_REQUEST_LOCATION) {
            if (grantResults.length > 0
                ...
                if (ContextCompat.checkSelfPermission(this,
                    ...
                    mFusedLocationClient.requestLocationUpdates(mLocationRequest, mLocationCallback, Looper.myLooper());
                   // mGoogleMap.setMyLocationEnabled(false);
                    Log.d("dfgdfgdfg","cgfdf121dfgfdgfd");
                }
    ...
    private void Register() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, FC_URL.URL_ADDUSER,
            ...
            protected Map<String, String> getParams() {
                ...
                if(FC_Common.check.equalsIgnoreCase("1"))
                {
                    params.put("id", FC_Common.addressid);
                    params.put("type", FC_Common.addresstype);
                    params.put("map_address", FC_Common.Address);
                    params.put("building", FC_Common.addressbuilding);
                    params.put("latitude", FC_Common.addresslatitude);
                    params.put("longitude", FC_Common.addresslongitude);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(FC_ManageEditAddressActivity.this);
                    ...
                    public void onResponse(String ServerResponse) {
                        ...
                        try {
                            ...
                            if (FC_Common.status.equalsIgnoreCase("1"))
                            {
                                ...
                                FC_SharedPrefManager.getInstance(FC_ManageEditAddressActivity.this).userLogin(user);
                                SharedPreferences sharedPreferences = FC_ManageEditAddressActivity.this.getSharedPreferences("MyLogin.txt", Context.MODE_PRIVATE);
                                SharedPreferences.Editor editor = sharedPreferences.edit();
                                //editor.putBoolean("FirstLogin", true);
                                editor.commit();
                                SharedPreferences sharedPreferences1 = PreferenceManager.getDefaultSharedPreferences(FC_ManageEditAddressActivity.this);
                                ...
                                Intent intent = new Intent(FC_ManageEditAddressActivity.this, FC_ManageAddressActivity.class);
                                intent.putExtra("addressid", FC_Common.addressid);
                                intent.putExtra("addresslandmark", FC_Common.addresslandmark);
                                intent.putExtra("addresstype", FC_Common.addresstype);
                                intent.putExtra("addressbuilding", FC_Common.addressbuilding);
