package food.user.demand.FCPojo.FCHotSellersHotelActivityObject;

public class HotSellersHotelObject {
    ...
    private String delivery_estimation ;
    private String person_limit ;
    private String cost_limit ;
    ...
    public void setDelivery_estimation(String delivery_estimation) {
    ...
    public String getCost_limit() {
        return cost_limit;
    }

    public void setCost_limit(String cost_limit) {
