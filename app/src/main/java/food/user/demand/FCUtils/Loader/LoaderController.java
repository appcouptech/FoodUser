...
public class LoaderController implements ValueAnimator.AnimatorUpdateListener {
    ...
    public void onDrawCirclar(Canvas canvas) {
        onDrawCircular(canvas, 0, 0, 0, 0);
    }

    private void onDrawCircular(Canvas canvas, float left_pad, float top_pad, float right_pad, float bottom_pad) {
