...
public class CheckoutActivityJava extends AppCompatActivity {
    ...
    //private static final String BACKEND_URL = "https://foodcoup.appcoup.com/api/driver/";
...
Log.d("dfghfdgdfg","dgsdf"+e);
    ...
    void displayAlert(@NonNull String title, @NonNull String message, boolean restartDemo) {
        runOnUiThread(() -> {
